...
userurlpatterns = [
    ...
    path('api/v1/users/<uuid:user_id>/favorite/', FavoritesFilmsAPIView.as_view(), name='user-favorite'),
    path('api/v1/users/<uuid:user_id>/favorite/<uuid:films_id>/', FavoritesFilmsAPIView.as_view(), name='user-favorite-film'),
]
